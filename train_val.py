...
# nohup python train_val.py --output-dir ./qwen3_4b_new_format_val > train_fmt_val.log 2>&1 &
...
DATASET_PATH = "/home/jcyang/Global-Chess-Challenge-2025-Baselines/data/ChessExplained_scored_obs.parquet"
...
training_args = TrainingArguments(
    ...
    run_name="new_format_val_obvious",
