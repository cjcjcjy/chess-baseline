...
# nohup python train_nvidia_new_format.py --output-dir ./qwen3_4b_new_format --resume-from /home/jcyang/Global-Chess-Challenge-2025-Baselines/qwen3_4b_new_format/checkpoint-34000> train_fmt.log 2>&1 &
...
DATASET_PATH = "/home/jcyang/Global-Chess-Challenge-2025-Baselines/data/ChessExplained_scored.parquet"
...
training_args = TrainingArguments(
    ...
    run_name="qwen3_4b_train_nvidia_new_format",
